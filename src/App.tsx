...
export default function App() {
  ...
  // --- ETATS MODALES PERSONNALISÉES (Remplace les pop-ups natives du navigateur) ---
  ...
  return (
    <div style={{ padding: '15px', maxWidth: '600px', margin: 'auto', fontFamily: 'system-ui, -apple-system, sans-serif', color: '#212529' }}>
        ...
        {!estAdmin ? (
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
              ...
              {historique.length > 0 && (
                <button 
                  ...
                  style={{ padding: '6px 12px', backgroundColor: '#d9534f', color: '#ffffff', border: 'none', borderRadius: '6px', cursor: 'pointer', fontWeight: '600', fontSize: '12px' }}
                >
            ...
            <div style={{ marginTop: '20px', paddingTop: '15px', borderTop: '1px solid #e9ecef', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: '13px', color: '#6c757d' }}>Registre (Archives) : <strong>{registreRapports.length}</strong></span>
              <button 
      ...
      {/* --- MODALE ALERTE PERSONNALISÉE --- */}
      {modaleAlerte.ouverte && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyConten
