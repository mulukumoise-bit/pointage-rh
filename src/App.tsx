  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f4f6f9', fontFamily: 'Arial, sans-serif', padding: '16px', color: '#333' }}>
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        ...
        {/* MODAL AFFICHAGE DU TEXTE SANS TÉLÉCHARGEMENT */}
        {showExportModal && (
          <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '16px' }}>
            <div style={{ backgroundColor: '#ffffff', padding: '20px', borderRadius: '12px', maxWidth: '400px', width: '100%', boxShadow: '0 4px 12px rgba(0,0,0,0.15)' }}>
              ...
              <div style={{ textAlign: 'center', marginBottom: '12px' }}>
                ...
                <h3 style={{ fontSize: '15px', margin: 0, color: '#0f3d3e' }}>Données prêtes pour Excel</h3>
                <p style={{ fontSize: '11px', color: '#64748b', margin: '4px 0 0 0' }}>
                  Cliquez sur "Copier", puis collez directement dans Excel (les colonnes se sépareront tout seules).
                </p>
              </div>
