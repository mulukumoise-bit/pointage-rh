...
export default function App() {
  ...
  // Exportation Excel robuste et directe (compatible mobile et PC)
  const handleExportExcel = () => {
    ...
    // Utilisation d'un Blob propre avec type MIME explicite
    const blob = new Blob([csvContent], { type: 'text/csv;charset=utf-8;' });
    const url = URL.createObjectURL(blob);
    
    const link = document.createElement("a");
    link.href = url;
    link.download = `Pointage_RH_${new Date().toISOString().slice(0,10)}.csv`;
