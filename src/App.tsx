...
export default function App() {
  ...
  // États pour les modales personnalisées (zéro popup natif moche)
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f4f6f9', fontFamily: 'Arial, sans-serif', padding: '16px', color: '#333' }}>
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        ...
        {/* MODAL DE CONFIRMATION POUR VIDER LE REGISTRE */}
        {showClearConfirm && (
          <div style={{
        ...
        {/* MODAL D'EXPORTATION EXCEL PERSONNALISÉ */}
        {showExportModal && (
          <div style={{
            position: 'fixed', top: 0, left: 0, right: 0, bottom: 0,
            backgroundColor: 'rgba(0, 0, 0, 0.5)', display: 'flex',
            ...
            <div style={{
              backgroundColor: '#ffffff', padding: '20px', borderRadius: '12px',
              maxWidth: '380px', width: '100%', boxShadow: '0 4px 12px rgba(0,0,0,0.15)'
            }}>
              <div style={{ textAlign: 'center', marginBottom: '14px' }}>
                <div style={{ fontSize: '28px', marginBottom: '4px' }}>📊</div>
                <h3 style={{ fontSize: '16px', margin: 0, color: '#0f3d3e' }}>Exporter le registre</h3>
                <p style={{ fontSize: '12px', color: '#64748b', margin: '4px 0 0 0' }}>
                  {records.length} enregistrement(s) prêt(s) au format CSV (Excel).
                </p>
              </div>
