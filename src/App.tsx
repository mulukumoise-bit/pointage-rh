        ...
        {!isAdminUnlocked ? (
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: '#475569', marginBottom: '12px' }}>
              ✓ Espace administrateur déverrouillé pour Atelier Tech.
            </div>
            ...
            {/* Tableau de l'historique au design exact des captures */}
              ...
              {records.map((r, index) => (
                <div key={r.id} style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr 1.6fr', padding: '12px 8px', borderBottom: index < records.length - 1 ? '1px solid #E2E8F0' : 'none', alignItems: 'center', fontSize: '11px' }}>
                  ...
                  <div style={{ color: '#64748B', fontSize: '10px' }}>
                    <div>{r.time}</div>
                    <div style={{ color: '#0F4C5C', marginTop: '2px', display: 'flex', alignItems: 'center', gap: '2px' }}>
                      📍 {r.coords}
                    </div>
                  </div>
                </div>
