...
interface AttendanceRecord {
  ...
  type: 'Arrivée' | 'Départ';
  timestamp: string;
  dateStr: string; // Format JJ/MM/AAAA
  rawDate: string; // Format AAAA-MM-JJ pour les filtres
  location: string;
...
export default function App() {
  ...
  // Position de référence de l'entreprise (Ex: Lubumbashi Centre)
  const COMPANY_LAT = -11.5705;
  const COMPANY_LON = 27.5510;
  const MAX_RADIUS_KM = 0.5; // 500 mètres de tolérance
  ...
  // Calcul de distance GPS (Formule de Haversine simplifiée)
        ...
        <div style={{ backgroundColor: '#ffffff', borderRadius: '20px', padding: '20px', border: '1px solid #E2E8F0', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
          ...
          {!isAdminUnlocked ? (
            ...
            <div>
              ...
              {/* Contrôles de session et export */}
