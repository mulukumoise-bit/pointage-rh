...
export default function App() {
  ...
  const handlePointer = (type: string) => {
    ...
    const saveRecord = (lat: number, lng: number) => {
      ...
      setName(''); // Efface immédiatement le champ pour le prochain employé
      
      setSuccessMessage(`✓ ${trimmedName} (${type}) enregistré !`);
      setTimeout(() => setSuccessMessage(''), 2500); // Disparaît rapidement (2.5s)
    };
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f4f6f9', fontFamily: 'Arial, sans-serif', padding: '16px', color: '#333' }}>
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        ...
        {/* Bloc Formulaire de Pointage (Ultra rapide pour les employés) */}
