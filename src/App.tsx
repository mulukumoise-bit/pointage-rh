...
export default function App() {
  ...
  return (
    <div style={{ padding: '15px', maxWidth: '600px', margin: 'auto', fontFamily: 'system-ui, -apple-system, sans-serif', color: '#212529' }}>
      ...
      <section style={{ backgroundColor: '#ffffff', padding: '16px', borderRadius: '12px', marginBottom: '20px', border: '1px solid #e9ecef', boxShadow: '0 2px 6px rgba(0,0,0,0.03)' }}>
        ...
        {!estAdmin ? (
          ...
          <div>
            ...
            <h4 style={{ margin: '0 0 12px 0', fontSize: '15px' }}>Historique des Pointages</h4>
            ...
            <div style={{ marginTop: '20px', paddingTop: '15px', borderTop: '1px solid #e9ecef', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: '13px', color: '#6c757d' }}>Archives enregistrées : <strong>{registreRapports.length}</strong></span>
              <button 
                onClick={() => alert('Génération du fichier CSV...')} 
      ...
      {afficherModaleSuppression && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '20px' }}>
          <div style={{ backgroundColor: '#ffffff', borderRadius: '12px', padding: '20px', maxWidth: '350px', width: '100%', textAlign: 'center', boxShadow: '0 10px 25px rgba(0,0,0,0.2)' }}>
            <h3 style={{ marginTop: 0, fontSize: '18px', color: '#212529' }}>Effacer l'historique ?</h3>
            <p style={{ color: '#6c757d', fontSize: '14px', marginBottom: '20px' }}>Cette action supprimera définitivement t
