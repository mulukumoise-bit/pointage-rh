...
export default function App() {
  ...
  const EnregistrerPointage = (type: 'Arrivée' | 'Départ') => {
    ...
    // Sécurité : si le GPS ne répond pas en 3 secondes, on valide quand même
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ background: '#fff', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
              ...
              <form onSubmit={ValiderAbonnement} style={{ marginTop: '12px' }}>
                ...
                <button type="submit" style={{ width: '100%', padding: '10px', background: '#0f172a', color: '#fff', border: 'none', borderRadius: '8px', fontWeight: 'bold', c
