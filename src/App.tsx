...
export default function App() {
  ...
  // Export direct vers Excel (format CSV compatible Excel avec séparateur point-virgule)
  const handleExportExcel = () => {
    ...
    link.setAttribute("download", `Pointage_${company.replace(/\s+/g, '_')}_${new Date().toISOString().slice(0,10)}.csv`);
